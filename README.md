...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sentinel-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15204&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sentinel-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sentinel` can be installed with:

```
conda install sentinel
```

It is possible to list all of the versions of `sentinel` available on your platform with:
